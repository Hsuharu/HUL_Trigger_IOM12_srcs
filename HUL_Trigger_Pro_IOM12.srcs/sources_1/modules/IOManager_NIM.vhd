...
begin
  ...
  nimout3    <= Else_OR                     when(reg_nimout3 = "000000") else
                ...
                BH2_K_OR                    when(reg_nimout3 = "001001") else
                Other1                      when(reg_nimout3 = "001010") else
                Other2                      when(reg_nimout3 = "001011") else
                Other3                      when(reg_nimout3 = "001100") else
                Other4                      when(reg_nimout3 = "001101") else
                Other5                      when(reg_nimout3 = "001110") else
                Clock_sel                   when(reg_nimout3 = "001111") else
                Reserve2_sel                when(reg_nimout3 = "010000") else
                BH1_or                      when(reg_nimout3 = "010001") else
                BH2_or                      when(reg_nimout3 = "010010") else
                SAC_or                      when(reg_nimout3 = "010011") else
                TOF_or                      when(reg_nimout3 = "010100") else
                Lucite_or                   when(reg_nimout3 = "010101") else
                TOF_High_Threshold          when(reg_nimout3 = "010110") else
                Beam                        when(reg_nimout3 = "010111") else
                Pi_Beam                     when(reg_nimout3 = "011000") else
                P_Beam                      when(reg_nimout3 = "011001") else
                K_Scat                      when(reg_nimout3 = "011010") else
                Beam_TOF                    when(reg_nimout3 = "011011") else
                Beam_Pi                     when(reg_nimout3 = "011100") else
                Beam_P                      when(reg_nimout3 = "011101") else
                Coin1                       when(reg_nimout3 = "011110") else
                Coin2                       when(reg_nimout3 = "011111") else
                For_E03                     when(reg_nimout3 = "100000") else
                BH2_Pi_PS                   when(reg_nimout3 = "100001") else
                Beam_TOF_PS                 when(reg_nimout3 = "100010") else 
                Beam_Pi_PS                  when(reg_nimout3 = "100011") else  
                Beam_P_PS                   when(reg_nimout3 = "100100") else  
                Coin1_PS                    when(reg_nimout3 = "100101") else  
                Coin2_PS                    when(reg_nimout3 = "100110") else  
                For_E03_PS                  when(reg_nimout3 = "100111") else --'0' ;
                clk1MHz                     when(reg_nimout3 = "101000") else  
                clk100kHz                   when(reg_nimout3 = "101001") else  
                clk10kHz                    when(reg_nimout3 = "101010") else  
                clk1kHz                     when(reg_nimout3 = "101011") else '0' ;
  ...
  nimout4    <= Else_OR                     when(reg_nimout4 = "000000") else
                ...
                BH2_K_OR                    when(reg_nimout4 = "001001") else
                Other1                      when(reg_nimout4 = "001010") else
                Other2                      when(reg_nimout4 = "001011") else
                Other3                      when(reg_nimout4 = "001100") else
                Other4                      when(reg_nimout4 = "001101") else
                Other5                      when(reg_nimout4 = "001110") else
                Clock_sel                   when(reg_nimout4 = "001111") else
                Reserve2_sel                when(reg_nimout4 = "010000") else
                BH1_or                      when(reg_nimout4 = "010001") else
                BH2_or                      when(reg_nimout4 = "010010") else
                SAC_or                      when(reg_nimout4 = "010011") else
                TOF_or                      when(reg_nimout4 = "010100") else
                Lucite_or                   when(reg_nimout4 = "010101") else
                TOF_High_Threshold          when(reg_nimout4 = "010110") else
                Beam                        when(reg_nimout4 = "010111") else
                Pi_Beam                     when(reg_nimout4 = "011000") else
                P_Beam                      when(reg_nimout4 = "011001") else
                K_Scat                      when(reg_nimout4 = "011010") else
                Beam_TOF                    when(reg_nimout4 = "011011") else
                Beam_Pi                     when(reg_nimout4 = "011100") else
                Beam_P                      when(reg_nimout4 = "011101") else
                Coin1                       when(reg_nimout4 = "011110") else
                Coin2                       when(reg_nimout4 = "011111") else
                For_E03                     when(reg_nimout4 = "100000") else
                BH2_Pi_PS                   when(reg_nimout4 = "100001") else
                Beam_TOF_PS                 when(reg_nimout4 = "100010") else 
                Beam_Pi_PS                  when(reg_nimout4 = "100011") else  
                Beam_P_PS                   when(reg_nimout4 = "100100") else  
                Coin1_PS                    when(reg_nimout4 = "100101") else  
                Coin2_PS                    when(reg_nimout4 = "100110") else  
                For_E03_PS                  when(reg_nimout4 = "100111") else -- '0' ;
                clk1MHz                     when(reg_nimout4 = "101000") else  
                clk100kHz                   when(reg_nimout4 = "101001") else  
                clk10kHz                    when(reg_nimout4 = "101010") else  
                clk1kHz                     when(reg_nimout4 = "101011") else '0' ;
